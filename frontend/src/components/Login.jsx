...
function Login({ onLogin, theme, toggleTheme }) {
  ...
  const demoUsers = [
    { email: 'abogado1@actslaw.com', cases: ['25092', '25096'] },
    { email: 'abogado2@actslaw.com', cases: ['25092'] },
    { email: 'abogado3@actslaw.com', cases: ['25097'] },
    { email: 'cliente@example.com', cases: ['25092'] },
    { email: 'admin@actslaw.com', cases: ['All'] }
  ]
            ...
            <div className="space-y-2">
              {demoUsers.map((user, index) => (
                <div
                  ...
                  onClick={() => {
                    setEmail(user.email)
                    setPassword(user.email.includes('admin') ? 'admin123' : 'password123')
                  }}
